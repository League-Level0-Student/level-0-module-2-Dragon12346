...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		int userMood = JOptionPane.showOptionDialog(null, "How do you feel?", "Mood GaMe", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Sad", "Happy", "Angry" }, null);
		
		// 2. Their answer is stored in the userMood variable. Print it out.
		System.out.println(userMood);
		// 3. If they are in a stressed mood, use the playVideo method to play a calming song from YouTube.
		if (userMood == 0) { playVideo("http://bit.ly/video-for-sad");
			
		}
		if (userMood == 1) { playVideo("http://bit.ly/video-for-happy");
		
		}
		if (userMood == 2) { playVideo("http://bit.ly/video-for-angry");
